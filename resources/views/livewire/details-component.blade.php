				...
				<div class="wrap-product-detail">
					...
					<div class="detail-info">
						<div class="product-rating">
							...
							@for($i=1; $i<=5; $i++) @if($i <=$avgrating) <i class="fa fa-star" aria-hidden="true"></i>
								...
								@endif
								@endfor
								<a href="#" class="count-review">({{$product->order_items->where('rstatus',
                                    1)->count()}}
									review)</a>
						</div>
						...
						<div class="wrap-butons">
							...
							<div class="wrap-btn wrap ">
								<br>
								<a href="#" class="btn btn-wishlist" style="background:white">Add
									Wishlist</a>
							</div>
						</div>
					</div>
					...
					<div class="advance-info">
						...
						<div class="tab-contents">
							...
							@php
							$ad_desc = explode(",", $product->aditional_desc);
							...
							<div class="tab-content-item " id="add_infomation">
								<table class="shop_attributes">
									<tbody>
										<tr>
											<th>Weight</th>
											<td class="product_weight">{{ $ad_desc[0] }}</td>
										</tr>
										<tr>
											<th>About Pricing</th>
											<td>{{ $ad_desc[1] }}</td>
							...
							<li class="service">
								<a class="link-to-service" href="#">
									...
									<div class="right-content">
										...
										<p class="desc">(but must call(01534770999) before the confirmation) ...</p>
									</div>
								</a>
							</li>
							...
							<li class="service">
								<a class="link-to-service" href="#">
									...
									<div class="right-content">
										...
										<span class="subtitle">Return within only 1 days</span>
										<p class="desc">please call(01534770999), to confirm about your specefic
											items.(caring cast
											will be your,sorry!)</p>
									</div>
								</a>
							</li>
						</ul>
