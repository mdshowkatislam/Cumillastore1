                    ...
                    <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="boost healthy drink jar">
                                    <figure><img src="{{ asset('images/products/boost-healthy-drink-jar-400-gm.png') }}"
                                            width="214" height="214" alt="boost-healthy-drink-jar-400-gm">
                                    </figure>
                                </a>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>boost-healthy-drink-jar-400-gm</span></a>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="haque milk chocolate digestive biscuit">
                                    <figure><img
                                            src="{{ asset('images/products/haque-milk-chocolate-digestive-biscuit-145-gm.png') }}"
                                            width="214" height="214"
                                            alt="haque-milk-chocolate-digestive-biscuit-145-gm"></figure>
                                </a>
                                <div class="group-flash">
                            ...
                            <div class="product-info">
                                <a href="#"
                                    class="product-name"><span>haque-milk-chocolate-digestive-biscuit-145-gm</span></a>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="mrcookie butter coconut biscuits">
                                    <figure><img
                                            src="{{ asset('images/products/mrcookie-butter-coconut-biscuits-220-gm.png') }}"
                                            width="214" height="214" alt="mrcookie-butter-coconut-biscuits-220-gm">
                                    </figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">new**</span>
                            ...
                            <div class="product-info">
                                <a href="#"
                                    class="product-name"><span>mrcookie-butter-coconut-biscuits-220-gm</span></a>
                                <div class="wrap-price"><ins>
                                        <p class="product-price">$168.00</p>
                                    </ins> <del>
                                        <p class="product-price">$250.00</p>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="miniket rice premium">
                                    <figure><img src="{{ asset('images/products/miniket-rice-premium-5-kg.png') }}"
                                            width="214" height="214" alt="miniket-rice-premium-5-kg"></figure>
                                </a>
                                <div class="group-flash">
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>miniket-rice-premium-5-kg</span></a>
                                <div class="wrap-price"><span class="product-price">$250.00</span></div>
                            </div>
                        </div>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="tibet rose lemon detergent powder 500">
                                    <figure><img
                                            src="{{ asset('images/products/tibet-rose-lemon-detergent-powder-500-gm.png') }}"
                                            width="214" height="214" alt="tibet-rose-lemon-detergent-powder-500-gm">
                                    </figure>
                                </a>
                                <div class="wrap-btn">
                                    <a href="#" class="function-link">quick view</a>
                            ...
                            <div class="product-info">
                                <a href="#"
                                    class="product-name"><span>tibet-rose-lemon-detergent-powder-500-gm</span></a>
                                <div class="wrap-price"><span class="product-price">$250.00</span></div>
                            </div>
                        </div>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="aci pure salt">
                                    <figure><img src="{{ asset('images/products/aci-pure-salt-1-kg.png') }}" width="214"
                                            height="214" alt="aci-pure-salt-1-kg"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item sale-label">sale</span>
                                </div>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>aci-pure-salt-1-kg</span></a>
                                <div class="wrap-price"><ins>
                                        <p class="product-price">$168.00</p>
                                    </ins> <del>
                                        <p class="product-price">$250.00</p>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="chicken-eggs-special-offer-12-pcs">
                                    <figure><img
                                            src="{{ asset('images/products/chicken-eggs-special-offer-12-pcs.png') }}"
                                            width="214" height="214" alt="chicken-eggs-special-offer-12-pcs"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item new-label">new</span>
                                </div>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>chicken-eggs-special-offer-12-pcs</span></a>
                                <div class="wrap-price"><span class="product-price">$250.00</span></div>
                            </div>
                        </div>
                        ...
                        <div class="product product-style-2 equal-elem ">
                            <div class="product-thumnail">
                                <a href="#" title="lux-soap-bar-soft-touch-35-gm">
                                    <figure><img src="{{ asset('images/products/lux-soap-bar-soft-touch-35-gm.png') }}"
                                            width="214" height="214" alt="lux-soap-bar-soft-touch-35-gm"></figure>
                                </a>
                                <div class="group-flash">
                                    <span class="flash-item bestseller-label">Bestseller</span>
                                </div>
                            ...
                            <div class="product-info">
                                <a href="#" class="product-name"><span>lux-soap-bar-soft-touch-35-gm</span></a>
                                <div class="wrap-price"><span class="product-price">$250.00</span></div>
                            </div>
                        </div>
                    </div>
