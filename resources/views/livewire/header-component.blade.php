                        ...
                        <ul>
                            ...
                            <li class="menu-item menu-item-has-children parent">
                                ...
                                <ul class="submenu curency">
                                    ...
                                    <li class="menu-item">
                                        <a title="Manage Home Slider" href="#">Manage
                                            Home Slider</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="Manage Home Categories" href="#">Manage Home Categories</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="Sale Setting" href="#">Sale Setting</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="All Coupon" href="#">All Coupon</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="All Orders" href="#">All Orders</a>
                                    </li>
                                    <li class="menu-item">
                                        <a title="Contact Messages" href="#">Contact
                                            Messages</a>
                                    </li>
                                    <li class="menu-item">
                            ...
                            <li class="menu-item menu-item-has-children parent">
                                ...
                                <ul class="submenu curency">
                                    ...
                                    <li class="menu-item">
                                        <a title="Change Password" href="#">Change
                                            Password</a>
                                    </li>
                                    <li class="menu-item">
                                        <a href="{{ route('logout') }}"
            ...
            <div class="container">
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="index.html" class="link-to-home"><img src="{{ asset('images/logo/logo-x.png') }}"
                                alt="mercado"></a>
                    </div>
                ...
                <div class="header-nav-section " style="width:100%;">
                    <div class="container ">
                        <ul class=" nav-bar nav menu-nav clone-main-menu" id="mercado_haead_menu"
                            ...
                            <li class="menu-item"><a href="{{ route('featured',['name'=>'special'] ) }}"
                                    class=" link-term">Special
                                    Items</a>
                                <span class="nav-label hot-label">hot</span>
                            </li>
                            <li class="menu-item"><a href="{{ route('featured',['name'=>'hot'] ) }}"
                                    class=" link-term">Hot
                                    Sale</a><span class="nav-label hot-label">hot</span></li>
                            <li class="menu-item"><a href="{{ route('featured',['name'=>'new'] ) }}"
                                    class=" link-term">Top
                                    new</a>
                                <span class="nav-label hot-label">hot</span>
                            </li>
                            <li class="menu-item"><a href="{{ route('featured',['name'=>'default'] ) }}"
                                    class=" link-term">General Items</a><span class="nav-label hot-label">hot</span>
                            </li>
                            <li class="menu-item"><a href="{{ route('featured',['name'=>'popular'] ) }}"
