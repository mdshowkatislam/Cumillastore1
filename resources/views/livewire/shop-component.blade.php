            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="#" class="banner-link">
                        <figure><img src="{{ asset('images/tinybanner/subbanner-2.png') }}" alt=""></figure>
                    </a>
                </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                                ...
                                <ul class="sub-cate">
                                    ...
                                    <li class="category-item">
                                        <a href="{{route('product.category', ['category_slug'=>$category->slug, 'scategory_slug'=>$scategory->slug])}}"
                                            class="cat-link"><i class="fa fa-caret-right"></i> {{$scategory->name}}</a>
                                    </li>
                                    @endforeach
                                </ul>
                                @endif
                ...
                <div class="widget mercado-widget filter-widget">
                    ...
                    <div class="widget-banner">
                        <figure><img src="{{ asset('images/tinybanner/side banner-2.jpg') }}" width="270" height="331"
                                alt=""></figure>
                    </div>
