<main id="main">
	...
	<div class="button-head">
		...
		<div class="product-action-2">
			<a href="detail/{{ $product['id'] }}">Add to cart</a>
		</div>
	</div>
	</div>
	<div class="product-content">
		<h3><a href="detail/{{ $product['id'] }}">{{ $product->title }}</a>
		</h3>
				...
				<div class="tab-contents">
					...
					<div class="tab-content-item {{$key==0 ? 'active':''}}" id="category_{{$category->id}}">
						<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
							...
							<div class="product product-style-2 equal-elem ">
								<div class="product-thumnail">
									{{-- <a href="{{route('product.details',['slug'=>$c_product->slug])}}" --}} <a
										href="detail/{{ $product->id }}" title="{{$c_product->name}}">
					...
					<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5"
						...
						<div class="product product-style-2 equal-elem ">
							<div class="product-thumnail">
								...
								<a class="banner-effect-2" href=" detail/{{ $mc->id }}">
									<figure>
										<img class="hover-img sealImage"
											src="{{ asset('images/allcategories') }}/{{$mc->photo}}" width="400"
											height="400" alt="{{$mc->title}}">
									</figure>
								</a>
							</div>
							<div class="product-info">
								<a href="detail/{{ $mc->id }}" class="product-name"><span>{{$mc->title}}</span></a>
								<div class="wrap-price"><span class="product-price">${{$mc->summary}}</span>
								</div>
							</div>
						</div>
						@endforeach
	...
	{{-- demo owl carousel for news feed --}}
