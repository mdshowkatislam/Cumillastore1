...
class CategoryComponent extends Component
{
    ...
    public function render()
    {
        ...
        {
            $scategory = subcategories::where('slug', $this->scategory_slug)->first();
        ...
        return view('livewire.category-component',['products'=> $products, 'categories'=>$categories, 'category_title'=>$category_title])->layout('layouts.base');
    }
}